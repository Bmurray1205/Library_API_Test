Being new to both GIT and RDF I had some decisions to make if I was to get the automation built.  I researched RDF and  helper tools like JENA, but didn't implement that code yet. 
